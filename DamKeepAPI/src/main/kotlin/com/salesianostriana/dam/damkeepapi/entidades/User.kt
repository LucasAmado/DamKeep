...
data class User(
    ...
    constructor(username: String, password: String, fullName: String, avatar: String, role: String) :
            this(username, password, fullName, avatar, mutableSetOf(role), true, true, true, true)
